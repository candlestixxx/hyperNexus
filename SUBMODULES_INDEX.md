...
|-----------|----------|----------|------------------|
| **jules-autopilot** | `apps/cloud-orchestrator` | `candlestixxx/jules-autopilot` | Cloud orchestration and TS fallback routing. (Synced) |
| **Maestro** | `apps/maestro` | `candlestixxx/Maestro` | Electron-based GUI client. (Synced, slated for native replacement) |
...
| **CLIProxyAPIPlus** | `submodules/CLIProxyAPIPlus` | `candlestixxx/CLIProxyAPIPlus` | Shell proxy utilities. |
| **LinJun** | `submodules/LinJun` | `wangdabaoqq/LinJun` | Agent workflows reference. |
| **HyperHarness** | `submodules/HyperHarness` | `candlestixxx/HyperHarness` | Primary local CLI orchestration system. |
| **pi-mono** | `submodules/pi-mono` | `candlestixxx/pi-mono` | Reference implementations. |
