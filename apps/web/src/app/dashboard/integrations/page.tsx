        ...
        <div className="p-8 space-y-8 h-full overflow-y-auto">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                <div>
                    ...
                    <p className="mt-2 max-w-3xl text-zinc-500">
                        Install HyperNexus into the environments you actually use: browser bridges, VS Code, and MCP-aware clients.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
                ...
                <StatCard
                    ...
                    detail="Detected config targets with existing HyperNexus-ready files"
                    icon={Settings2}
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-4">
                <Card className="bg-zinc-900 border-zinc-800">
                    <CardHeader>
                        <CardTitle className="text-white">Installable HyperNexus surfaces</CardTitle>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-3 text-sm text-zinc-300">
                        ...
                        <Link href="/dashboard/mcp/settings" className="flex items-start gap-3 rounded-lg border border-zinc-800 bg-zinc-950/50 p-4 hover:border-zinc-700 hover:bg-zinc-950">
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-xs text-zinc-400">Preview and write HyperNexus-managed MCP configs for Claude Desktop, Cursor, and VS Code.</div>
                            </div>
                        </Link>
                                ...
                                <div key={row.id} className="rounded-lg border border-zinc-800 bg-zinc-950/50 p-4">
                                    <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-zinc-400">
                                            ...
                                            {row.detected ? 'Detected on this machine' : 'Not detected from HyperNexus yet'}
                                        </div>
                                    </div>
                                </div>
                            ))}
