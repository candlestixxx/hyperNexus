  ...
  return (
    <div className="w-full h-full flex flex-col bg-black text-white">
      <div className="p-4 border-b border-zinc-800 flex flex-wrap items-center justify-between gap-3 bg-zinc-900">
        <div>
          <h1 className="text-xl font-bold">Jules Autopilot Console</h1>
          <p className="text-zinc-400 text-sm">Run and supervise Jules sessions directly from HyperNexus.</p>
        </div>
