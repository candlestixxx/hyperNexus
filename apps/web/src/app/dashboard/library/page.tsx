...
export default function LibraryDashboard() {
    ...
    const sections: ResourceSection[] = [
        {
            title: "Saved Scripts",
            description: "Reusable automation scripts for common HyperNexus operations and workflows.",
        ...
        {
            title: "Skills",
            description: "Curated skill bundles that extend HyperNexus's reasoning and action capabilities.",
        ...
        {
            title: "Memory Bank",
            description: "Searchable observations, prompts, and session summaries persisted by HyperNexus.",
        ...
        {
            title: "Plans",
            description: "Structured reasoning plans and goal decompositions generated or stored by HyperNexus.",
        ...
        {
            title: "Manual",
            description: "Operator documentation, usage guides, and feature reference for HyperNexus.",
        ...
        {
            title: "Chronicle",
            description: "Git commit history and working-tree status for the active HyperNexus workspace.",
            ...
            <div className="flex items-start justify-between">
                <div>
                    ...
                    <p className="text-zinc-500 mt-2 max-w-2xl">
                        Central hub for scripts, skills, tool sets, memory, plans, and documentation — all the reusable resources that power HyperNexus workflows.
                    </p>
                </div>
                {isLoading && (
