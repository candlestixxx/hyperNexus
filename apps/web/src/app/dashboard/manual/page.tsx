...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@hypernexus/ui";
                ...
                <TabsContent value="getting-started">
                    <Card className="bg-zinc-950 border-zinc-800">
                        ...
                        <CardContent className="space-y-4">
                            <p>The HyperNexus is an autonomous agentic system designed for self-evolving software development.</p>
                        ...
                        <Card className="bg-zinc-950 border-zinc-800">
                            ...
                            <CardContent>
                                <p className="text-sm text-zinc-400">
                                    The HyperNexus can learn new capabilities by ingesting documentation.
