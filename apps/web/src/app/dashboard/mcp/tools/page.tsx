                ...
                <CardContent className="flex-1 overflow-auto p-0 bg-[#0c0c0c] font-mono text-[11px] lg:text-xs">
                    {isLoading ? (
                        ...
                        <div className="p-8 text-zinc-600">
                            <span className="text-emerald-500">server@hypernexus</span><span className="text-zinc-400">:</span><span className="text-blue-500">~</span>$ No commands logged in recent history.
                        </div>
                    ) : (
                                ...
                                <li key={entry.id} className="p-3 hover:bg-white/[0.02] transition-colors group">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-1">
                                        <div className="flex items-center gap-2 text-zinc-400">
                                            <span className="text-emerald-500">agent@hypernexus</span>
