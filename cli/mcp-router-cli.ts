...
import { McpSessionService, type PerformanceMetrics } from '../packages/core/src/services/McpSessionService.js';
...
program
    ...
    .action(async (options, command) => {
        const requestedFormat = command.args[0] || program.opts().format || 'hypernexus';
