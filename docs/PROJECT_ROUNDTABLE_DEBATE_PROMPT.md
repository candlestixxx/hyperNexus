# hypernexus Frontier-Model Roundtable Debate Prompt
...
You are participating in a structured architecture and product roundtable about **hypernexus**, a local AI operations control plane for builders.
...
- hypernexus is fundamentally a **local AI control plane**, not a chatbot app.
...
- hypernexus already has real implementations for startup/readiness, MCP inspection, session supervision, billing/provider surfaces, and memory search/timeline/pivot flows.
- hypernexus’s largest near-term risks are:
  - documentation drift
  - scope inflation
  - product truth drift
  - parity theater
...
1. What is hypernexus’s smallest compelling 1.0?
...
7. What are the top ways hypernexus could still fail from here?
...
- If you recommend a feature, explain why it strengthens hypernexus as a control plane.
...
### 1. Verdict
Give a blunt 1-paragraph judgment on hypernexus’s current state.

### 2. Kernel
List the 3 to 6 core things hypernexus fundamentally should be.

### 3. Stop doing
List what hypernexus should demote, quarantine, or stop pretending is product-complete.
...
### 5. Proposed roadmap
Describe hypernexus **1.0**, **1.5**, and **2.0** from this point forward.
