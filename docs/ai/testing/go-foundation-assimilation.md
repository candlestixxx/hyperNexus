...
- HyperNexus provider routing integration
- HyperNexus MCP inventory integration
...
5. compatibility tests against richer HyperNexus-backed provider/MCP adapters
