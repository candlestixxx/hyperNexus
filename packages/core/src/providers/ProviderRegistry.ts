import { DEFAULT_OPENROUTER_FREE_MODEL } from '@hypernexus/ai';
...
export const DEFAULT_PROVIDER_CATALOG: ProviderDefinition[] = [
    ...
    },
    {
        ...
        models: [
            ...
            },
            {
                ...
                contextWindow: 64_000,
                tier: 'premium',
                recommendedFor: ['planning', 'research'],
    ...
    },
    {
        ...
        models: [
            ...
            {
                id: 'openrouter/best-available-coding',
                provider: 'openrouter',
                name: 'Best Available Coding (Meta)',
                inputPrice: null,
                outputPrice: null,
                contextWindow: null,
                tier: 'meta',
