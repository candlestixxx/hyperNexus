            ...
            try {
                ...
                if (res.ok) {
                    ...
                    return {
                        ...
                        message: "Goal successfully delegated to HyperNexus Orchestrator."
                    };
                }
            } catch (e: any) {
                console.warn(`[Supervisor] HyperNexus Orchestrator unavailable (${e.message}). Falling back to native supervisor.`);
            }
        }
