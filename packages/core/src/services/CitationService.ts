 ...
 *
 * This is the HyperNexus equivalent of NotebookLM's "Grounded Answers" feature.
 */
...
export class CitationService {
    ...
    constructor(config?: Partial<CitationServiceConfig>) {
        ...
        // Store vector DB locally in the global user .hypernexus directory
        const os = require('os');
        this.lancedbPath = `${os.homedir()}/.hypernexus/citations_db`;
    }
