...
export class McpConfigService {
    ...
    /**
     * Reads HyperNexus's mcp.jsonc (falling back to mcp.json) and updates the database to match.
     * This makes HyperNexus's config file the authoritative source for config entry existence/content.
     */
