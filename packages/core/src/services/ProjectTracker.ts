 ...
 * - Maintains a JSON history file (`.hypernexus/tracker_history.json`) for durable state
...
export class ProjectTracker {
    ...
    constructor(rootDir: string) {
        ...
        // Store history in .hypernexus directory to keep project root clean
        this.historyPath = path.join(rootDir, '.hypernexus', 'tracker_history.json');
    }
     ...
     * Creates the .hypernexus directory if it doesn't exist.
     */
    private appendToHistory(task: ProjectTask): void {
        try {
            ...
            // Ensure .hypernexus directory exists
