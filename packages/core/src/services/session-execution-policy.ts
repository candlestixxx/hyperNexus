        ...
        case 'powershell': {
            ...
            return toPolicy(
                ...
                preferred
                    ...
                    : 'A PowerShell shell was requested, but HyperNexus could not verify any shell on this host.',
            );
        }
        ...
        case 'posix': {
            ...
            return toPolicy(
                ...
                preferred
                    ...
                    : 'A POSIX shell was requested, but HyperNexus could not verify any shell on this host.',
            );
        }
        ...
        case 'compatibility': {
            return toPolicy(
                ...
                compatibilityShell
                    ...
                    : 'Compatibility mode was requested, but HyperNexus could not verify any shell on this host.',
            );
        }
        ...
        default: {
            if (environment.os === 'win32' && powerShell) {
                return toPolicy(
                    ...
                    'powershell',
                    powerShell,
                    `${powerShell.name} selected automatically as HyperNexus's preferred Windows execution shell for general harness supervision.`,
                );
            }
            ...
            return toPolicy(
                ...
                preferred,
                preferred
                    ? `${preferred.name} selected automatically as the only verified shell HyperNexus can trust on this host.`
