 ...
 *
 * Example: `.hypernexus/skills/deploy-to-prod/SKILL.md`
 */
 ...
 * SkillRegistry
 *
 * Discovers, loads, and manages HyperNexus's skill library.
...
export class SkillRegistry {
    ...
    async loadSkills() {
        ...
        console.log(`HyperNexus Core: Loaded ${this.skills.size} skills.`);
    }
    ...
    async createSkill(id: string, name: string, description: string) {
        // Default to the first search path (usually .hypernexus/skills in cwd)
